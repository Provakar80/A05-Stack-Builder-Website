      ...
      <nav className="sticky top-0 z-50 w-full bg-white/95 backdrop-blur-md border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-linear-to-r from-orange-500 via-pink-500 to-violet-600 flex items-center text-white font-bold text-lg justify-center shadow-md">
              DS
            </div>
            <span className="text-xl font-extrabold tracking-tight text-slate-900">
              Dev <span className="bg-linear-to-r from-orange-500 via-pink-500 to-violet-600 bg-clip-text text-transparent">Stack</span>
            </span>
          </div>
          ...
          <div className="md:hidden flex items-center justify-between w-full">
            ...
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-lg bg-linear-to-r from-orange-500 via-pink-500 to-violet-600 flex items-center text-white font-bold text-xs justify-center shadow">
                DS
              </div>
      ...
      <section id="home" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center text-center lg:text-left">
        <div className="space-y-6 flex flex-col items-center lg:items-start">
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-4 pt-2 w-full">
            <a href="#technologies" className="px-6 sm:px-7 py-3.5 rounded-xl text-white font-semibold bg-linear-to-r from-orange-500 via-pink-500 to-violet-600 shadow-lg hover:opacity-90 transition">
                  ...
                  return (
                    <div key={tech.id} className="bg-white rounded-2xl border border-slate-100 p-6 flex flex-col justify-between shadow-sm hover:shadow-md transition">
                      ...
                      <button
                        ...
                        disabled={isAdded}
                        className={`w-full py-2.5 rounded-xl font-semibold text-sm transition flex items-center justify-center gap-2 ${isAdded
      ...
      <footer id="contact" className="w-full bg-white border-t border-slate-100 mt-10 pt-16 pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col items-center text-center md:hidden space-y-4">
            <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-linear-to-r from-orange-500 via-pink-500 to-violet-600 flex items-center text-white font-bold text-base justify-center shadow">
                DS
              </div>
              <span className="text-xl font-extrabold tracking-tight text-slate-900">
          ...
          <div className="hidden md:grid grid-cols-5 gap-10">
            <div className="col-span-2 space-y-4">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-linear-to-r from-orange-500 via-pink-500 to-violet-600 flex items-center text-white font-bold text-md justify-center">
                  DS
                </div>
